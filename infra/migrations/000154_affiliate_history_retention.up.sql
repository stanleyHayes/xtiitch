-- Affiliate financial, referral, risk, and audit history must survive account
-- lifecycle changes. Application workflows archive Affiliate records; these
-- constraints also prevent an accidental direct delete from cascading through
-- historical evidence.
