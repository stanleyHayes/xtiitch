...
- Subscription invoice/payment-link/manual billing controls, operator-run dunning/grace-expiry sweeps, and cancellation-to-free downgrade rules now exist in admin; automatic Paystack recurring authorization, recurring webhook reconciliation, scheduled grace expiry, and plan-limit enforcement are still pending.
