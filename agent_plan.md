...
- Admin notifications, reports, operations health, and authenticated server-side CSV export/download endpoints are API-backed for the current admin datasets; keep adding rows as new admin features ship.
