...
- Finish business-user hardening: email invites, owner-transfer policy, and continue service-level role enforcement across remaining protected API boundaries beyond auth/team/measurement/availability/password-reset/catalogue-management.
