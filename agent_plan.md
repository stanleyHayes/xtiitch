...
- Subscription invoice/payment-link/manual billing controls and operator-run dunning/grace-expiry sweeps now exist in admin; automatic Paystack recurring authorization, recurring webhook reconciliation, scheduled grace expiry, downgrade rules, and plan-limit enforcement are still pending.
