...
2. Add automatic subscription billing mechanics: Paystack recurring authorization/charge initiation. Webhook reconciliation, grace-expiry automation, downgrade rules, and design plan-limit enforcement now exist.
...
- Subscription invoice/payment-link/manual billing controls, operator-run and worker-scheduled dunning/grace-expiry sweeps, cancellation-to-free downgrade rules, subscription webhook reconciliation, and catalogue design plan-limit enforcement now exist; automatic Paystack recurring authorization/charge initiation is still pending.
