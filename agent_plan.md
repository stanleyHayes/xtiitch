...
- Admin notification and reporting surfaces still derive from the loaded admin read models; operations health is API-backed and authenticated server-side CSV export/download endpoints now exist for the current admin datasets.
