...
- Finish business-user hardening: continue service-level role enforcement across remaining protected API boundaries beyond auth/team/measurement/availability/password-reset/catalogue-management/media-signing/money-management/order-money/invite-email/owner-transfer/booking-operations/handover-operations/order-operations; next known gap is the protected payment-checkout charge endpoint.
