...
- Subscription invoice/payment-link/manual billing controls now exist in admin; automatic Paystack recurring authorization, recurring webhook reconciliation, grace expiry automation, downgrade rules, and plan-limit enforcement are still pending.
