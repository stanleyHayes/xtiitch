...
- Admin reporting still derives from the loaded admin read models; notifications and operations health are API-backed, and authenticated server-side CSV export/download endpoints now exist for the current admin datasets.
