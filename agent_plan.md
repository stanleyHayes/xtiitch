...
- Growth & monetisation layer (see `## Growth & Monetisation`): plan-package CRUD, admin promotion-definition CRUD, scoped checkout redemption/application, admin sponsored-placement campaign controls, admin affiliate registry/reporting, the admin referral-programme definition registry, public affiliate-click ingestion, checkout affiliate-attribution reservation, webhook conversion materialisation, and affiliate payout reconciliation now exist; remaining slices are business-side promotion controls, referral attribution/reward execution, and public sponsored placement rendering/event tracking on the marketing site — businesses act on their own customers; admin acts on businesses and customers; all delivered via discount-at-charge / commission-rebate / vouchers or Xtiitch-owned ad revenue so the no-funds-held invariant holds.
