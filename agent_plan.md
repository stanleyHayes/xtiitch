...
- Finish business-user hardening: email invites/password resets, owner-transfer policy, and continue service-level role enforcement across remaining protected API boundaries beyond auth/team/measurement.
