...
const SECTIONS: { heading: string; paragraphs: string[] }[] = [
  {
    ...
    paragraphs: [
      "Applying does not create an affiliate account. Applications are reviewed by Xtiitch, and we may accept or decline any application at our discretion. If accepted, you'll receive an activation link by email to set a password and open your portal.",
  ...
  return (
    <div className="doc-shell">
      ...
      <main className="doc">
        ...
        <p className="lede">
          These terms cover taking part in the Xtiitch affiliate programme —
          how you're accepted, how referrals are attributed, how commission is
