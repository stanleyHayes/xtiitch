...
type fakeAdminBusinesses struct {
	...
	decidedAffiliateApplication ports.DecideAdminAffiliateApplicationInput
	...
	growthReport                ports.AdminGrowthReportRecord
...
func (fake *fakeAdminBusinesses) GetAdminGrowthReport(
	...
	fake.growthReportFrom = from
	fake.growthReportTo = to
	return fake.growthReport, nil
}
