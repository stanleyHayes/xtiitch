...
import { AffiliateDirectoryTable } from "./AffiliateDirectoryTable";
...
export function AffiliateTable({
  ...
  return (
    <>
      ...
      {!affiliatesError && affiliates.length > 0 ? (
        <>
          <AffiliateDirectoryTable affiliates={pagedAffiliates} affiliateAttribution={affiliateAttribution} onSelect={onSelect} />
          <PaginationFooter
            count={pageCount}
            label="Affiliates"
            page={page}
