...
export function HelpGuideCard({
  ...
  return (
    ...
    >
      ...
      <Box component="ol" sx={{ mt: 1.5, mb: 0, pl: 2.5, color: "text.primary" }}>
        {guide.steps.map((step, index) => (
          <Box
            component="li"
            key={index}
            sx={{ mb: 0.75, lineHeight: 1.55, "&::marker": { color: tokens.burgundy, fontWeight: 800 } }}
          >
            {step}
          </Box>
        ))}
...
// Per-page help: a right-hand drawer showing the guide for the current section,
// opened from the "?" button in the top bar.
