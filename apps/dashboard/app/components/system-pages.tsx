    ...
    >
      ...
      <Container sx={{ position: "relative", maxWidth: 680 }}>
        <Stack spacing={3} sx={{ alignItems: "center", textAlign: "center" }}>
          ...
          >
            <DashboardCustomizeRounded sx={{ fontSize: 34 }} />
          </Box>
          <Box>
            <Typography
              variant="overline"
...
export function SplashPage() {
  return (
    <WorkspaceSystemPage
      ...
      message="Orders, catalogue, payments and customer tools are being prepared for this session."
